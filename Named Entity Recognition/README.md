...
This repository contains the codebase and experiments for extracting 14 Legal Named Entities from Indian Supreme Court judgments using the EkStep dataset. We fine-tuned the `evolawyer/inlegalbert-sc-ner-silver` model and conducted extensive ablation studies comparing different architectures (BiLSTM, GAT, Concatenation).
...
| DATE | 0.87 | 0.88 | 0.89 | 
| GPE | 0.76 | 0.75 | 0.78 | 
| JUDGE | 0.90 | **0.94** | **0.94** | 
| LAWYER | 0.87 | 0.95 | 0.95 | 
| ORG | 0.72 | **0.76** | 0.75 | 
| OTHER_PERSON | 0.82 | 0.84 | **0.87** | 
| PETITIONER | 0.69 | 0.77 | 0.78 | 
| PRECEDENT | 0.73 | 0.75 | **0.78** | 
| PROVISION | 0.92 | 0.92 | **0.94** | 
| RESPONDENT | 0.72 | 0.73 | 0.77 | 
| STATUTE | 0.90 | 0.91 | 0.93 | 
| WITNESS | 0.86 | 0.90 | **0.93** | 

## How to Run

To train and evaluate any of the models:
1. Navigate to the `src/` directory.
2. Select the Jupyter Notebook corresponding to the architecture you wish to run (e.g., `src/concat/concat.ipynb`).
