...
def main():
    ...
    optimized_sft_weights = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'weights', 'optimized_baseline_small', 'final'))
    print(f"Loading SFT LoRA weights for Optimized from {optimized_sft_weights}...")
    model = PeftModel.from_pretrained(base_model, optimized_sft_weights, is_trainable=True)
    model.print_trainable_parameters()
    
    dpo_data_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'processed', 'IN-Abs_DPO_Baseline'))
    
    print("Loading Optimized DPO datasets...")
    ...
    output_weights_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'weights', 'dpo_baseline'))
    ...
    print("Initializing DPOTrainer for Optimized...")
    ...
    print("Starting Optimized DPO Fine-tuning...")
    dpo_trainer.train()
    
    print("Saving final Optimized DPO model...")
