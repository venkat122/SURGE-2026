...
def main():
    ...
    print(f"Loading Phase 3 Tagged Dataset from: {rhetorical_dataset_root}")
    train_dataset, test_dataset = get_in_abs_datasets(dataset_root=rhetorical_dataset_root)
    ...
    output_weights_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'weights', 'rhetorical_role'))
